...
const Registration = () => {
  ...
  const handleClick = async (e) => {
    ...
    if (!regData.terms) {
      return setErrorMsg("Please accept terms & conditions")
    }
    try {
      ...
      <div className="relative w-full">
        ...
        <Container>
          <div className="flex items-center absolute top-1/2 -translate-y-1/2 gap-x-3 z-10">
            ...
            <MdOutlineChevronRight className='text-base text-[#808080]' />
            <h4 className='font-pop text-base text-hgreen'>
              Create Account
            </h4>
          </div>
        </Container>
          ...
          <div className="max-w-130 mx-auto rounded-[10px]  border border-[#F2F2F2] shadow-[0px_0px_56px_rgba(0,38,3,0.08)] px-10 py-12">
            ...
            <form className='flex flex-col gap-y-5'>
              ...
              <div className="relative">
                ...
                {showPassword ? (
                  <IoEyeOutline
                    ...
                    className="absolute top-6.25 right-2.5 text-[20px] cursor-pointer text-[#1A1A1A]"/> ) : 
                (
                  <IoEyeOffOutline
              ...
              <button
                type="button"
                onClick={handleClick}
                className='bg-hgreen hover:bg-green-700 duration-300 text-white font-pop font-semibold py-4 rounded-full mt-2' >
                Create Account
              </button>
